            ...
            <div className="block w-full 800px:flex">
              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div className="flex items-center mt-12 justify-between pr-3">
                  <div>
                    <button
                      className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-l px-4 py-2 shadow-lg hover:opacity-75 transition duration-300 ease-in-out rounded-md"
                      onClick={decremantCount}
                    >
                      -
                    </button>
                ...
                <div
                  className={`${styles.button} !mt-6 !rounded !h-11 flex items-centser`}
                ...
                <div className="flex items-center pt-8">
                  ...
                  <div
                    className={`${styles.button} bg-[#6443d1] m-4 !rounded !h-11`}
    ...
    <div className="bg-[#f5f6fb] px-3 800px:px-10 py-2 rounded ">
      <div className="w-full flex justify-between border-b pt-10 pb-2">
        <div className="relative">
          <h5
            className={
              "text-[#000] text-[10px] px-1 leading-5 font-[600] cursor-pointer 800px:text-[20px] "
            }
            onClick={() => setActive(1)}
          >
            Product Details
