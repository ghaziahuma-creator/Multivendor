...
import { categoriesData, productData } from "../../src/static/data";
import {
  AiOutlineHeart,
  AiOutlineSearch,
...
function Header({ activeHeading }) {
  ...
  return (
    <>
      ...
      <div
        className={`${active === true ? "shadow-sm fixed top-0 left-0 z-10 " : null} transition hidden 800px:flex items-center justify-between w-full bg-[#3321c8] h-[70px] px-8`}
      >
        <div
      ...
      {/* Mobile Header */}
      <div
        className={` ${active === true ? "shadow-sm fixed top-0 left-0 z-10 " : null} w-full h-[60px] fixed bg-[#fff] z-50 top-0 left-0 shadow-sm 800px:hidden  `}
      >
                ...
                {isAuthenticated ? (
                  <div>
                   <Link to="/profile">
                    ...
                    className="w-[60px] h-[60px] rounded-full border-[3px] border-[#05dbad]"
                    />
                   </Link>
                  </div>
                ) : (
