  ...
  return (
    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://www.lg.com/content/dam/lge/global/our-brand/src/mocks/bs0002/brand-elements-logo-primary-d.svg"
            alt=""
            style={{width:"150px", objectFit:"contain"}}
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRxq4Z2FMH_vSDsZ35nkFCleRBu9gU9T3jkKomBFcPmQ&s=10"
            alt=""
            style={{width:"150px", objectFit:"contain"}}
          />
        </div>
