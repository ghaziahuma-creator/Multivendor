...
toast.success("Item added to cart successfully!");
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:[w-50%] flex flex-col justify-center mx-8 ">
        ...
        <div className="flex py-2 justify-between">
          <div className="flex">
            ...
            <h5 className="font-bold text-[20px] text-[#333] font font-Roboto">
              {data.discountPrice}$
            </h5>
          </div>
          <span className="pr-3 font-[400] text-[17px] text-[#08eb44]">
            {data.sold_out} Sold
          </span>
        </div>
        <CountDown data={data} />
